...
`ɪ'ᴍ ʜᴇʀᴇ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴛᴏ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘꜱ ᴀɴᴅ ɪ ᴍ ᴠᴇʀʏ ᴘᴏᴡᴇʀꜰᴜʟʟ ʙᴏᴛ! ʜɪᴛ` /help
 [😈](https://telegra.ph/file/6b84e6444b12b1bea8149.jpg)
"""

buttons = [
    [
        InlineKeyboardButton(
            text="ᴀᴅᴅ Devil Bot ᴛᴏ ᴜʀ ᴄʜᴀᴛ", url="t.me/TGN_Ro_bot?startgroup=true"),
    ],
    [
...
ᴀʟꜱᴏ ʏᴏᴜ ᴄᴀɴ ᴀꜱᴋ ᴀɴʏᴛʜɪɴɢ ɪɴ ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ [😈](https://telegra.ph/file/986df1b08f0da9138a386.jpg)"""

START_IMG = "https://telegra.ph/file/70358634282a6cbb9644d.mp4"
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_video(
            START_IMG, caption= "<code>Devil is Here For You😈\nI am Awake Since</code>: <code>{}</code>".format(
                uptime            
            ),
